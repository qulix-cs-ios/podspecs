Pod::Spec.new do |s|
  ...
  s.source = { :http => "http://cs-repo.qulix.com/content/repositories/ios/com/qulix/ioskit/ioskit-utils/0.10.3/ioskit-utils.zip" }
  ...
  s.subspec 'validation' do |subspec|
    ...
    subspec.dependency 'ioskit-logger', '0.10.3'
    subspec.dependency 'ioskit-utils/error'
  end
