Pod::Spec.new do |s|
  ...
  s.source = { :http => "http://cs-repo.qulix.com/content/repositories/ios/com/qulix/ioskit/ioskit-utils/1.5.10/ioskit-utils.zip" }
  ...
  s.subspec 'validation' do |subspec|
    ...
    subspec.dependency 'ioskit-logger', '1.5.10'
    subspec.dependency 'ioskit-utils/error'
  end
