Pod::Spec.new do |s|
  ...
  s.source = { :http => "http://cs-repo.qulix.com/content/repositories/ios/com/qulix/ioskit/ioskit-utils/1.17.2/ioskit-utils.zip" }
  ...
  s.subspec 'threedsecure' do |subspec|
    subspec.source_files = "ioskit-utils/src/threedsecure/**/*.{h,m,swift}"
  end
  ...
  s.subspec 'deviceInfo' do |subspec|
    subspec.source_files = "ioskit-utils/src/deviceInfo/**/*.{h,m,swift}"
  end
  ...
  s.subspec 'casting' do |subspec|
    ...
    subspec.dependency 'ioskit-utils/validation'
  end
  ...
  s.subspec 'mapper' do |subspec|
    subspec.source_files = "ioskit-utils/src/mapper/**/*.{swift}"
    subspec.dependency 'ioskit-utils/casting'
  end

  s.subspec 'validation' do |subspec|
    subspec.source_files = "ioskit-utils/src/validation/**/*.{swift}"
    subspec.dependency 'ioskit-logger', '1.17.2'
    subspec.dependency 'ioskit-utils/error'
  end
  ...
  s.subspec 'textDecoder' do |subspec|
    ...
    subspec.dependency 'ioskit-utils/error'
    subspec.dependency 'ioskit-utils/mapper'
  end

  s.subspec 'expressionTemplateEngine' do |subspec|
    subspec.source_files = "ioskit-utils/src/expressionTemplateEngine/**/*.{swift}"
    subspec.dependency 'ioskit-utils/casting'
    subspec.dependency 'ioskit-utils/regex'
    subspec.dependency 'expression_swift'
  end

  s.subspec 'regex' do |subspec|
    subspec.source_files = "ioskit-utils/src/regex/**/*.{swift}"
  end
  ...
  s.subspec 'asn1' do |subspec|
    subspec.source_files = "ioskit-utils/src/asn1/**/*.{swift}"
  end
