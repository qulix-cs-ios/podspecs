Pod::Spec.new do |s|
  ...
  s.source = { :http => "http://cs-repo.qulix.com/content/repositories/ios/com/qulix/ioskit/ioskit-utils/0.1.41/ioskit-utils.zip" }
  ...
  s.subspec 'casting' do |subspec|
    ...
    subspec.dependency 'ioskit-utils/errors'
  end
  
  s.subspec 'errors' do |subspec|
    subspec.source_files = "ioskit-utils/src/errors/**/*.{swift}"
  end
