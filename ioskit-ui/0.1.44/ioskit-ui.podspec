Pod::Spec.new do |s|
  ...
  s.source = { :http => "http://cs-repo.qulix.com/content/repositories/ios/com/qulix/ioskit/ioskit-ui/0.1.44/ioskit-ui.zip" }
  s.platform = :ios, '8.0'
  s.requires_arc = true
  ...
  s.subspec 'WebPresenter' do |ss|
    ss.source_files = 'ioskit-ui/src/WebPresenter/*.{swift}'
  end
