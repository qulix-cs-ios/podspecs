Pod::Spec.new do |s|
  ...
  s.source = { :http => "http://cs-repo.qulix.com/content/repositories/ios/com/qulix/ioskit/ioskit_utils/2.1.1/ioskit_utils.zip" }
  ...
  s.subspec 'validation' do |subspec|
    ...
    subspec.dependency 'ioskit_logger', '2.1.1'
    subspec.dependency 'ioskit_utils/error'
  end
  ...
  s.subspec 'textDecoder' do |subspec|
    ...
    subspec.dependency 'ioskit_utils/error'
    subspec.dependency 'ioskit_utils/mapper'
  end

  s.subspec 'expressionTemplateEngine' do |subspec|
    subspec.source_files = "ioskit_utils/src/main/expressionTemplateEngine/**/*.{swift}"
    subspec.dependency 'ioskit_utils/casting'
    subspec.dependency 'ioskit_utils/regex'
    subspec.dependency 'expression_swift'
  end

  s.subspec 'regex' do |subspec|
    subspec.source_files = "ioskit_utils/src/main/regex/**/*.{swift}"
  end
