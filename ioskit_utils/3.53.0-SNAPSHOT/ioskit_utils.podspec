Pod::Spec.new do |spec|
  ...
  spec.source = { :http => "https://cs-repo.qulix.com/content/repositories/snapshots/com/ioskittest/ioskit_utils/3.53.0-SNAPSHOT/ioskit_utils-3.53.0-20240515.082407-2.zip" }
  ...
  spec.dependency 'IOSSecuritySuite', '2.0.2'
end
