Pod::Spec.new do |spec|
  ...
  spec.source = { :http => "https://cs-repo.qulix.com/content/repositories/snapshots/com/ioskittest/ioskit_utils/3.21.0-SNAPSHOT/ioskit_utils-3.21.0-20201014.174152-6.zip" }
  ...
  spec.dependency 'BiometricAuthentication', '3.1.3.1-SNAPSHOT'
