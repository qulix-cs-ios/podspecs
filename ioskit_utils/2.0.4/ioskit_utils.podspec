Pod::Spec.new do |s|
  ...
  s.source = { :http => "http://cs-repo.qulix.com/content/repositories/ios/com/qulix/ioskit/ioskit_utils/2.0.4/ioskit_utils.zip" }
  s.platform = :ios, '9.0'
  s.requires_arc = true
  ...
  s.subspec 'validation' do |subspec|
    ...
    subspec.dependency 'ioskit_logger', '2.0.4'
    subspec.dependency 'ioskit_utils/error'
  end
