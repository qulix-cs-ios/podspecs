Pod::Spec.new do |spec|
  ...
  spec.source = { :http => "http://cs-repo.qulix.com/content/repositories/ios/com/qulix/ioskit/ioskit_utils/2.1.5/ioskit_utils.zip" }
  ...
  spec.dependency 'ioskit_logger', '2.1.5'
