Pod::Spec.new do |spec|
  ...
  spec.source = { :http => "https://cs-repo.qulix.com/content/repositories/snapshots/com/ioskittest/ioskit_utils/3.41.0-SNAPSHOT/ioskit_utils-3.41.0-20211209.163144-4.zip" }
