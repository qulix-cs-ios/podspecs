Pod::Spec.new do |s|
  ...
  s.source = { :http => "https://cs-repo.qulix.com/content/repositories/snapshots/com/ioskittest/ioskit_wallet/3.58.0-SNAPSHOT/ioskit_wallet-3.58.0-20241209.113833-2.zip" }
