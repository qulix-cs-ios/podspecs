Pod::Spec.new do |s|
  ...
  s.source = { :http => "http://cs-repo.qulix.com/content/repositories/ios/com/qulix/ioskit/ioskit-deeplinks/1.10.0/ioskit-deeplinks.zip" }
  ...
  s.dependency 'ioskit-utils', '1.10.0'
