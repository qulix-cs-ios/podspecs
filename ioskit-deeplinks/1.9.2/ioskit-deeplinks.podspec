Pod::Spec.new do |s|
  ...
  s.source = { :http => "http://cs-repo.qulix.com/content/repositories/ios/com/qulix/ioskit/ioskit-deeplinks/1.9.2/ioskit-deeplinks.zip" }
  ...
  s.dependency 'ioskit-utils', '1.9.2'
