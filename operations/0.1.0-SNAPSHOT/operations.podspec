Pod::Spec.new do |spec|
  ...
  spec.source = { :http => "https://cs-repo.qulix.com/content/repositories/snapshots/com/operations/operations/0.1.0-SNAPSHOT/operations-0.1.0-20210412.143030-33.zip" }
