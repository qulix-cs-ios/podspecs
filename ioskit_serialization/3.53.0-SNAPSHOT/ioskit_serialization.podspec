Pod::Spec.new do |spec|
  ...
  spec.source = { :http => "https://cs-repo.qulix.com/content/repositories/snapshots/com/ioskittest/ioskit_serialization/3.53.0-SNAPSHOT/ioskit_serialization-3.53.0-20240510.110934-1.zip" }
