Pod::Spec.new do |spec|
  ...
  spec.source = { :http => "https://cs-repo.qulix.com/content/repositories/snapshots/com/ioskittest/ioskit_serialization/2.11.0-SNAPSHOT/ioskit_serialization-2.11.0-20200319.091729-1.zip" }
