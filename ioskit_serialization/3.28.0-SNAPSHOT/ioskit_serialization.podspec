Pod::Spec.new do |spec|
  ...
  spec.source = { :http => "https://cs-repo.qulix.com/content/repositories/snapshots/com/ioskittest/ioskit_serialization/3.28.0-SNAPSHOT/ioskit_serialization-3.28.0-20210401.121548-6.zip" }
