Pod::Spec.new do |spec|
  ...
  spec.source = { :http => "https://cs-repo.qulix.com/content/repositories/snapshots/com/ioskittest/ioskit_serialization/3.40.0-SNAPSHOT/ioskit_serialization-3.40.0-20210830.135618-1.zip" }
