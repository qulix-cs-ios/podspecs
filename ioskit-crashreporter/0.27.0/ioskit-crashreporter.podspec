Pod::Spec.new do |s|
  ...
  s.source = { :http => "http://cs-repo.qulix.com/content/repositories/ios/com/qulix/ioskit/ioskit-crashreporter/0.27.0/ioskit-crashreporter.zip" }
  ...
  s.dependency 'ioskit-logger', '0.27.0'
