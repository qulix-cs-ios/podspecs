Pod::Spec.new do |s|
  ...
  s.source = { :http => "http://cs-repo.qulix.com/content/repositories/ios/com/qulix/ioskit/ioskit-crashreporter/1.0.0/ioskit-crashreporter.zip" }
  ...
  s.dependency 'ioskit-logger', '1.0.0'
