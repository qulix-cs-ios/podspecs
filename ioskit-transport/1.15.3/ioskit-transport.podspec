Pod::Spec.new do |s|
  ...
  s.source = { :http => "http://cs-repo.qulix.com/content/repositories/ios/com/qulix/ioskit/ioskit-transport/1.15.3/ioskit-transport.zip" }
  s.platform = :ios, '9.3'
  s.requires_arc = true
  ...
  s.dependency 'ioskit-serialization', '1.15.3'
