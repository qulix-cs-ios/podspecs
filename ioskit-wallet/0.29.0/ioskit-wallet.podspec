Pod::Spec.new do |s|
  ...
  s.source = { :http => "http://cs-repo.qulix.com/content/repositories/ios/com/qulix/ioskit/ioskit-wallet/0.29.0/ioskit-wallet.zip" }
  ...
  s.ios.frameworks = 'UIKit', 'Foundation', 'PassKit'
