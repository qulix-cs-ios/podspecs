Pod::Spec.new do |s|
  ...
  s.source = { :http => "http://cs-repo.qulix.com/content/repositories/ios/com/qulix/ioskit/ioskit-urlhandler/1.14.7/ioskit-urlhandler.zip" }
  ...
  s.dependency 'ioskit-utils', '1.14.7'
