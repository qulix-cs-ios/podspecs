Pod::Spec.new do |s|
  ...
  s.source = { :http => "http://cs-repo.qulix.com/content/repositories/ios/com/qulix/ioskit/ioskit-urlhandler/1.13.1/ioskit-urlhandler.zip" }
  ...
  s.dependency 'ioskit-utils', '1.13.1'
