Pod::Spec.new do |s|
  ...
  s.source = { :http => "https://cs-repo.qulix.com/repository/ios/com/ioskittest/ioskit_crashreporter/2.7.14/ioskit_crashreporter-2.7.14.zip" }
  ...
  s.dependency 'ioskit_logger', '2.7.14'
