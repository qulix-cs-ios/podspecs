Pod::Spec.new do |s|
  ...
  s.source = { :http => "https://cs-repo.qulix.com/content/repositories/snapshots/com/ioskittest/ioskit_crashreporter/2.13.0-SNAPSHOT/ioskit_crashreporter-2.13.0-20200325.120550-1.zip" }
  ...
  s.dependency 'ioskit_logger', '2.13.0-SNAPSHOT'
