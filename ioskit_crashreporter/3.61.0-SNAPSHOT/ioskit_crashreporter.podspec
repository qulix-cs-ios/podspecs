Pod::Spec.new do |s|
  ...
  s.source = { :http => "https://cs-repo.qulix.com/repository/public-snapshots/com/ioskittest/ioskit_crashreporter/3.61.0-SNAPSHOT/ioskit_crashreporter-3.61.0-20251209.082752-1.zip" }
  ...
  s.dependency 'ioskit_logger', '3.61.0-SNAPSHOT'
