Pod::Spec.new do |s|
  ...
  s.source = { :http => "https://cs-repo.qulix.com/content/repositories/snapshots/com/ioskittest/ioskit_crashreporter/3.32.0-SNAPSHOT/ioskit_crashreporter-3.32.0-20210526.074527-1.zip" }
  ...
  s.dependency 'ioskit_logger', '3.32.0-SNAPSHOT'
