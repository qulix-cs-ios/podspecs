Pod::Spec.new do |s|
  ...
  s.source = { :http => "https://cs-repo.qulix.com/content/repositories/snapshots/com/ioskittest/ioskit_crashreporter/3.35.0-SNAPSHOT/ioskit_crashreporter-3.35.0-20210607.083944-1.zip" }
  ...
  s.dependency 'ioskit_logger', '3.35.0-SNAPSHOT'
