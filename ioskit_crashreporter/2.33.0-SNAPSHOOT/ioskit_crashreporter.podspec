Pod::Spec.new do |s|
  ...
  s.source = { :http => "https://cs-repo.qulix.com/content/repositories/releases/com/ioskittest/ioskit_crashreporter/2.33.0-SNAPSHOOT/ioskit_crashreporter-2.33.0-SNAPSHOOT.zip" }
  ...
  s.dependency 'ioskit_logger', '2.33.0-SNAPSHOOT'
