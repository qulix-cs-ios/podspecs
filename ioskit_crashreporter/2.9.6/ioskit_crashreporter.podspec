Pod::Spec.new do |s|
  ...
  s.source = { :http => "https://cs-repo.qulix.com/content/repositories/releases/com/ioskittest/ioskit_crashreporter/2.9.6/ioskit_crashreporter-2.9.6.zip" }
  ...
  s.dependency 'ioskit_logger', '2.9.6'
