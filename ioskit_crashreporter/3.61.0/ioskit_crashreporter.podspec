Pod::Spec.new do |s|
  ...
  s.source = { :http => "https://cs-repo.qulix.com/repository/public/com/ioskittest/ioskit_crashreporter/3.61.0/ioskit_crashreporter-3.61.0.zip" }
  ...
  s.dependency 'ioskit_logger', '3.61.0'
