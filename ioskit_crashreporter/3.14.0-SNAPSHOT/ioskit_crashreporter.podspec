Pod::Spec.new do |s|
  ...
  s.source = { :http => "https://cs-repo.qulix.com/content/repositories/snapshots/com/ioskittest/ioskit_crashreporter/3.14.0-SNAPSHOT/ioskit_crashreporter-3.14.0-20200824.051126-1.zip" }
  ...
  s.dependency 'ioskit_logger', '3.14.0-SNAPSHOT'
