Pod::Spec.new do |s|
  ...
  s.source = { :http => "https://cs-repo.qulix.com/content/repositories/snapshots/com/ioskittest/ioskit_crashreporter/3.44.0-SNAPSHOT/ioskit_crashreporter-3.44.0-20220110.103329-2.zip" }
  ...
  s.dependency 'ioskit_logger', '3.44.0-SNAPSHOT'
