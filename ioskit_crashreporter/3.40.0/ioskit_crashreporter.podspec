Pod::Spec.new do |s|
  ...
  s.source = { :http => "https://cs-repo.qulix.com/content/repositories/releases/com/ioskittest/ioskit_crashreporter/3.40.0/ioskit_crashreporter-3.40.0.zip" }
  ...
  s.dependency 'ioskit_logger', '3.40.0'
