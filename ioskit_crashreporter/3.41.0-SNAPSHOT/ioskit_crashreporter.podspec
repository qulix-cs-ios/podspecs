Pod::Spec.new do |s|
  ...
  s.source = { :http => "https://cs-repo.qulix.com/content/repositories/snapshots/com/ioskittest/ioskit_crashreporter/3.41.0-SNAPSHOT/ioskit_crashreporter-3.41.0-20211209.163144-1.zip" }
  ...
  s.dependency 'ioskit_logger', '3.41.0-SNAPSHOT'
