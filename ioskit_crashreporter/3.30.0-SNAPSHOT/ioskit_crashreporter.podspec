Pod::Spec.new do |s|
  ...
  s.source = { :http => "https://cs-repo.qulix.com/content/repositories/snapshots/com/ioskittest/ioskit_crashreporter/3.30.0-SNAPSHOT/ioskit_crashreporter-3.30.0-20210519.151138-2.zip" }
  ...
  s.dependency 'ioskit_logger', '3.30.0-SNAPSHOT'
