Pod::Spec.new do |s|
  ...
  s.source = { :http => "https://cs-repo.qulix.com/content/repositories/snapshots/com/ioskittest/ioskit_crashreporter/2.15.0-SNAPSHOT/ioskit_crashreporter-2.15.0-20200325.150725-1.zip" }
  ...
  s.dependency 'ioskit_logger', '2.15.0-SNAPSHOT'
