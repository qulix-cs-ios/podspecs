Pod::Spec.new do |s|
  ...
  s.source = { :http => "https://cs-repo.qulix.com/content/repositories/releases/com/ioskittest/ioskit_crashreporter/0.0.1/ioskit_crashreporter-0.0.1.zip" }
  ...
  s.dependency 'ioskit_logger', '0.0.1'
