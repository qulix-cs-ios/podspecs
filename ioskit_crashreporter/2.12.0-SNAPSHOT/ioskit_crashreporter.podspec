Pod::Spec.new do |s|
  ...
  s.source = { :http => "https://cs-repo.qulix.com/content/repositories/snapshots/com/ioskittest/ioskit_crashreporter/2.12.0-SNAPSHOT/ioskit_crashreporter-2.12.0-20200321.060801-5.zip" }
  ...
  s.dependency 'ioskit_logger', '2.12.0-SNAPSHOT'
