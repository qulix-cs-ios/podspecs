Pod::Spec.new do |s|
  ...
  s.source = { :http => "https://cs-repo.qulix.com/content/repositories/snapshots/com/ioskittest/ioskit_crashreporter/2.20.0-SNAPSHOT/ioskit_crashreporter-2.20.0-20200512.144321-1.zip" }
  ...
  s.dependency 'ioskit_logger', '2.20.0-SNAPSHOT'
