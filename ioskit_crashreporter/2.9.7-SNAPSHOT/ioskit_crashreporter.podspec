Pod::Spec.new do |s|
  ...
  s.source = { :http => "https://cs-repo.qulix.com/content/repositories/snapshots/com/ioskittest/ioskit_crashreporter/2.9.7-SNAPSHOT/ioskit_crashreporter-2.9.7-20200317.090714-2.zip" }
  ...
  s.dependency 'ioskit_logger', '2.9.7-SNAPSHOT'
