Pod::Spec.new do |s|
  ...
  s.source = { :http => "https://cs-repo.qulix.com/content/repositories/snapshots/com/ioskittest/ioskit_crashreporter/3.40.0-SNAPSHOT/ioskit_crashreporter-3.40.0-20210901.153532-2.zip" }
  ...
  s.dependency 'ioskit_logger', '3.40.0-SNAPSHOT'
