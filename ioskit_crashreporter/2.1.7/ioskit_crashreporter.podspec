Pod::Spec.new do |s|
  ...
  s.source = { :http => "http://cs-repo.qulix.com/content/repositories/ios/com/qulix/ioskit/ioskit_crashreporter/2.1.7/ioskit_crashreporter.zip" }
  s.platform = :ios, '9.0'
  s.requires_arc = true
  ...
  s.dependency 'ioskit_logger', '2.1.7'
