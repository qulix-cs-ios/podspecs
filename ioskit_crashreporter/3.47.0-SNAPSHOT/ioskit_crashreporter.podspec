Pod::Spec.new do |s|
  ...
  s.source = { :http => "https://cs-repo.qulix.com/content/repositories/snapshots/com/ioskittest/ioskit_crashreporter/3.47.0-SNAPSHOT/ioskit_crashreporter-3.47.0-20230124.130511-1.zip" }
  ...
  s.dependency 'ioskit_logger', '3.47.0-SNAPSHOT'
