Pod::Spec.new do |s|
  ...
  s.source = { :http => "https://cs-repo.qulix.com/repository/ios/com/ioskittest/ioskit_crashreporter/2.7.5/ioskit_crashreporter-2.7.5.zip" }
  s.source_files = 'ioskit_crashreporter/src/**/*.{swift,h}'
  ...
  s.dependency 'ioskit_logger', '2.7.5'
