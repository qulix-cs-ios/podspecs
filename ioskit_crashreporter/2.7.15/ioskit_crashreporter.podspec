Pod::Spec.new do |s|
  ...
  s.source = { :http => "https://cs-repo.qulix.com/repository/ios/com/ioskittest/ioskit_crashreporter/2.7.15/ioskit_crashreporter-2.7.15.zip" }
  ...
  s.dependency 'ioskit_logger', '2.7.15'
