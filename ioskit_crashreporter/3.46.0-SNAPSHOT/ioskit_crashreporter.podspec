Pod::Spec.new do |s|
  ...
  s.source = { :http => "https://cs-repo.qulix.com/content/repositories/snapshots/com/ioskittest/ioskit_crashreporter/3.46.0-SNAPSHOT/ioskit_crashreporter-3.46.0-20221017.094927-1.zip" }
  ...
  s.dependency 'ioskit_logger', '3.46.0-SNAPSHOT'
