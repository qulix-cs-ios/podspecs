Pod::Spec.new do |s|
  ...
  s.source = { :http => "https://cs-repo.qulix.com/content/repositories/snapshots/com/ioskittest/ioskit_crashreporter/3.57.0-SNAPSHOT/ioskit_crashreporter-3.57.0-20241112.141954-1.zip" }
  s.source_files = 'ioskit_crashreporter/src/**/*.{swift,h,m}'
  s.platform = :ios, '13.0'
  s.requires_arc = true
  s.ios.frameworks = 'UIKit', 'Foundation', 'MessageUI'
  s.dependency 'KSCrash', '2.0.0-rc.6'
  s.dependency 'SSZipArchive', '2.4.3'
  s.dependency 'ioskit_logger', '3.57.0-SNAPSHOT'
