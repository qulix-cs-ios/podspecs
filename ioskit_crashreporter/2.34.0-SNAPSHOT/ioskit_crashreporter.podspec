Pod::Spec.new do |s|
  ...
  s.source = { :http => "https://cs-repo.qulix.com/content/repositories/snapshots/com/ioskittest/ioskit_crashreporter/2.34.0-SNAPSHOT/ioskit_crashreporter-2.34.0-20210330.115741-1.zip" }
  ...
  s.dependency 'ioskit_logger', '2.34.0-SNAPSHOT'
