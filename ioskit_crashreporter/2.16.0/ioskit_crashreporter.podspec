Pod::Spec.new do |s|
  ...
  s.source = { :http => "https://cs-repo.qulix.com/content/repositories/releases/com/ioskittest/ioskit_crashreporter/2.16.0/ioskit_crashreporter-2.16.0.zip" }
  ...
  s.dependency 'ioskit_logger', '2.16.0'
