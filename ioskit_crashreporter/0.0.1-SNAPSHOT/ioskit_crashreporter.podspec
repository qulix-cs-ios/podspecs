Pod::Spec.new do |s|
  ...
  s.source = { :http => "https://cs-repo.qulix.com/content/repositories/snapshots/com/ioskittest/ioskit_crashreporter/0.0.1-SNAPSHOT/ioskit_crashreporter-0.0.1-20200316.075417-1.zip" }
  ...
  s.dependency 'ioskit_logger', '0.0.1-SNAPSHOT'
