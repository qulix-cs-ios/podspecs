Pod::Spec.new do |s|
  ...
  s.source = { :http => "https://cs-repo.qulix.com/content/repositories/snapshots/com/ioskittest/ioskit_crashreporter/3.52.0-SNAPSHOT/ioskit_crashreporter-3.52.0-20240328.082214-1.zip" }
  s.source_files = 'ioskit_crashreporter/src/**/*.{swift,h,m}'
  s.platform = :ios, '13.0'
  s.requires_arc = true
  s.ios.frameworks = 'UIKit', 'Foundation', 'MessageUI'
  s.dependency 'KSCrash', '1.17.0'
  s.dependency 'SSZipArchive', '2.4.3.1'
  s.dependency 'ioskit_logger', '3.52.0-SNAPSHOT'
