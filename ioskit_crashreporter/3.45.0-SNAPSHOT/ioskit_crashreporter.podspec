Pod::Spec.new do |s|
  ...
  s.source = { :http => "https://cs-repo.qulix.com/content/repositories/snapshots/com/ioskittest/ioskit_crashreporter/3.45.0-SNAPSHOT/ioskit_crashreporter-3.45.0-20220614.091223-2.zip" }
  ...
  s.dependency 'ioskit_logger', '3.45.0-SNAPSHOT'
