Pod::Spec.new do |s|
  ...
  s.source = { :http => "https://cs-repo.qulix.com/content/repositories/snapshots/com/ioskittest/ioskit_crashreporter/3.38.0-SNAPSHOT/ioskit_crashreporter-3.38.0-20210713.085704-1.zip" }
  ...
  s.dependency 'ioskit_logger', '3.38.0-SNAPSHOT'
