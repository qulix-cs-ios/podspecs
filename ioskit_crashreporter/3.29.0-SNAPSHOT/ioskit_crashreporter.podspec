Pod::Spec.new do |s|
  ...
  s.source = { :http => "https://cs-repo.qulix.com/content/repositories/snapshots/com/ioskittest/ioskit_crashreporter/3.29.0-SNAPSHOT/ioskit_crashreporter-3.29.0-20210406.114705-5.zip" }
  ...
  s.dependency 'ioskit_logger', '3.29.0-SNAPSHOT'
