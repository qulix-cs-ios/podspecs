Pod::Spec.new do |s|
  ...
  s.source = { :http => "https://cs-repo.qulix.com/repository/ios/com/qulix/ioskit/ioskit_transport/2.4.3/ioskit_transport.zip" }
  s.platform = :ios, '9.3'
  s.requires_arc = true
  s.source_files = 'ioskit_transport/src/main/**/*.{swift,h,m}'
  s.ios.frameworks = 'UIKit', 'Foundation'
  s.dependency 'ioskit_serialization', '2.4.3'
