Pod::Spec.new do |s|
  ...
  s.source = { :http => "https://cs-repo.qulix.com/content/repositories/snapshots/com/ioskittest/ioskit_logger/3.21.0-SNAPSHOT/ioskit_logger-3.21.0-20201014.173903-4.zip" }
