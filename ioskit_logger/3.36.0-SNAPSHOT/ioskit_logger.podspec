Pod::Spec.new do |s|
  ...
  s.source = { :http => "https://cs-repo.qulix.com/content/repositories/snapshots/com/ioskittest/ioskit_logger/3.36.0-SNAPSHOT/ioskit_logger-3.36.0-20210616.160243-10.zip" }
