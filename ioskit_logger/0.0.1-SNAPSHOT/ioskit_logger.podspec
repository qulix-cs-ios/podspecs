Pod::Spec.new do |s|
  ...
  s.source = { :http => "https://cs-repo.qulix.com/content/repositories/snapshots/com/ioskittest/ioskit_logger/0.0.1-SNAPSHOT/ioskit_logger-0.0.1-20200316.134007-1.zip" }
