Pod::Spec.new do |s|
  ...
  s.source = { :http => "https://cs-repo.qulix.com/content/repositories/snapshots/com/ioskittest/ioskit_logger/2.18.0-SNAPSHOT/ioskit_logger-2.18.0-20200415.142836-4.zip" }
