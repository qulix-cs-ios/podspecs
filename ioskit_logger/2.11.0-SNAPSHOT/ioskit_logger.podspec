Pod::Spec.new do |s|
  ...
  s.source = { :http => "https://cs-repo.qulix.com/content/repositories/snapshots/com/ioskittest/ioskit_logger/2.11.0-SNAPSHOT/ioskit_logger-2.11.0-20200319.091729-3.zip" }
