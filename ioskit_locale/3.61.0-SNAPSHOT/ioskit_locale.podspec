Pod::Spec.new do |s|
  ...
  s.source = { :http => "https://cs-repo.qulix.com/repository/public-snapshots/com/ioskittest/ioskit_locale/3.61.0-SNAPSHOT/ioskit_locale-3.61.0-20251209.082752-1.zip" }
  s.source_files = 'ioskit_locale/src/main/**/*.{h,m,swift}'
  s.platform = :ios, '15.0'
  s.requires_arc = true
  s.frameworks = 'Foundation'
  s.dependency 'ioskit_utils', '3.61.0-SNAPSHOT'
  s.dependency 'ioskit_storage', '3.61.0-SNAPSHOT'
