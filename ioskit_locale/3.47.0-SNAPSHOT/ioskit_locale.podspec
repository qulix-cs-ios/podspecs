Pod::Spec.new do |s|
  ...
  s.source = { :http => "https://cs-repo.qulix.com/content/repositories/snapshots/com/ioskittest/ioskit_locale/3.47.0-SNAPSHOT/ioskit_locale-3.47.0-20230124.130511-1.zip" }
  s.source_files = 'ioskit_locale/src/main/**/*.{h,m,swift}'
  s.platform = :ios, '10.0'
  s.requires_arc = true
  s.frameworks = 'Foundation'
  s.dependency 'ioskit_utils', '3.47.0-SNAPSHOT'
  s.dependency 'ioskit_storage', '3.47.0-SNAPSHOT'
