Pod::Spec.new do |s|
  ...
  s.source = { :http => "http://cs-repo.qulix.com/content/repositories/ios/com/qulix/ioskit/ioskit-swiftparser/0.1.32-SNAPSHOT/ioskit-swiftparser.zip" }
