Pod::Spec.new do |spec|
  ...
  spec.source = { :http => "http://cs-repo.qulix.com/content/repositories/ios/com/qulix/ioskit/ioskit_reflection/2.0.5/ioskit_reflection.zip" }
  spec.platform = :ios, '9.0'
  spec.requires_arc = true
  spec.source_files = 'ioskit_reflection/src/main/**/*.{swift}'
  spec.ios.frameworks = 'UIKit', 'Foundation'
  spec.dependency 'Reflection', '0.15.0'
  spec.dependency 'ioskit_utils', '2.0.5'
