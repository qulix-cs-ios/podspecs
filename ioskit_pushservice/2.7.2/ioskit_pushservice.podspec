Pod::Spec.new do |s|
  ...
  s.source = { :http => "https://cs-repo.qulix.com/repository/ios/com/qulix/ioskit/ioskit_pushservice/2.7.2/ioskit_pushservice.zip" }
  s.platform = :ios, '10.0'
  s.requires_arc = true
  s.source_files = 'ioskit_pushservice/src/main/**/*.{swift,h,m}'
  s.ios.frameworks = 'UIKit', 'Foundation'
  s.dependency 'ioskit_logger', '2.7.2'
  s.dependency 'ioskit_utils', '2.7.2'
