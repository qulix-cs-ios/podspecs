Pod::Spec.new do |spec|
  ...
  spec.source = { :http => "http://cs-repo.qulix.com/content/repositories/ios/com/qulix/ioskit/ioskit-reflection/1.0.0.beta.4/ioskit-reflection.zip" }
  ...
  spec.dependency 'ioskit-utils', '1.0.0.beta.4'
