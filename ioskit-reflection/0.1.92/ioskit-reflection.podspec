Pod::Spec.new do |spec|
  ...
  spec.source = { :http => "http://cs-repo.qulix.com/content/repositories/ios/com/qulix/ioskit/ioskit-reflection/0.1.92/ioskit-reflection.zip" }
  ...
  spec.dependency 'ioskit-utils', '0.1.92'
