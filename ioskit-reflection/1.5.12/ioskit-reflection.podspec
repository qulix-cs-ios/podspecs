Pod::Spec.new do |spec|
  ...
  spec.source = { :http => "http://cs-repo.qulix.com/content/repositories/ios/com/qulix/ioskit/ioskit-reflection/1.5.12/ioskit-reflection.zip" }
  ...
  spec.dependency 'ioskit-utils', '1.5.12'
