Pod::Spec.new do |spec|
  ...
  spec.source = { :http => "http://cs-repo.qulix.com/content/repositories/ios/com/qulix/ioskit/ioskit-serialization/0.1.133/ioskit-serialization.zip" }
  ...
  spec.dependency 'ioskit-reflection', '0.1.133'
