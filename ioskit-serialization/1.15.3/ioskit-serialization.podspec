Pod::Spec.new do |spec|
  ...
  spec.source = { :http => "http://cs-repo.qulix.com/content/repositories/ios/com/qulix/ioskit/ioskit-serialization/1.15.3/ioskit-serialization.zip" }
  ...
  spec.dependency 'ioskit-reflection', '1.15.3'
