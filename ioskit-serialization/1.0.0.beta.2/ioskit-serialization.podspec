Pod::Spec.new do |spec|
  ...
  spec.source = { :http => "http://cs-repo.qulix.com/content/repositories/ios/com/qulix/ioskit/ioskit-serialization/1.0.0.beta.2/ioskit-serialization.zip" }
  ...
  spec.dependency 'ioskit-reflection', '1.0.0.beta.2'
